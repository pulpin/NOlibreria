...
namespace LogicaNegocios
{
    public class Editorial
    {
        ...
        public DataTable Tabladedatos_editoriales()
        {
            ...
            con.AbrirConexio();
            return con.Mostrar_Datos("select EDI_CODIGO,EDI_EDITORIAL from libreria.editorial order by EDI_EDITORIAL");
        }
        ...
        public DataTable Tabladedatos_editorialesTodos()
        {
            Conexion con = new Conexion("libreria", Globales.ip);
            con.AbrirConexio();
            return con.Mostrar_Datos("select * from libreria.editorial order by EDI_EDITORIAL");
        }
        ...
        public DataTable Tabladedatos_editorialesAva()
        {
            ...
            Conexion con = new Conexion("libreria", Globales.ip);
            con.AbrirConexio();
            return con.Mostrar_Datos("select * from libreria.editorial where "+ valor +" order by EDI_EDITORIAL");
        }
