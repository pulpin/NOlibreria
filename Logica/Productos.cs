...
namespace LogicaNegocios
{
    public class Productos
    {
        ...
        private void descuentosoloconsigna()
        {
            ...
            rdr = con.Consultas("select * from libreria.consignas where CONS_LI_CODIGOVIEJO = '" + this.Codigo + "' and CONS_CANTIDAD > 0 order by CONS_NROCONSIG");
                ...
                if (rdr.HasRows)
                {
                    while (rdr.Read())
                    {
                        ...
                        else
                        {
                            ...
                            string querycon = "UPDATE libreria.consignas SET CONS_CANTIDAD = 0 where  CONS_IDE = " + consideactual + "";
                    ...
                    if (descontar > 0)
                    {
                        ...
                        string querypro = "UPDATE libreria.libros SET LI_PROPIO = " + stockpropio1 + ", LI_STOCK = " + stockasetear + " where  LI_CODIGOVIEJO = '" + this.Codigo + "'";
                        con.InsertarYactualiza(querypro);
        ...
        public void DescontarStock()
        {
            ...
            try
            {
                ...
                if (eslibro > 0) //aca pregunto si no es un libro que haga el descuento directamente.
                {
                    ...
                    string query = "UPDATE libreria.libros SET LI_PROPIO = " + stockpropio + ", LI_STOCK = " + stockasetear + " where  LI_CODIGOVIEJO = '" + this.Codigo + "'";
                        ...
                        if (stockpropiop > 0)
                        {
                            if (this.Cantidad <= stockpropiop)
                            {
                              ...
                              //  propioactual = this.spConsultastockpropi();
                                ...
                                string query = "UPDATE libreria.libros SET LI_PROPIO = " + propioactual + ", LI_STOCK = " + stockasetear + " where  LI_CODIGOVIEJO = '" + this.Codigo + "'";
                                con.InsertarYactualiza(query);
                                //registrar la venta
                                resultadop = this.spRegistrarlasVentas(0, this.Cantidad,0);
                            }
                            else
                            {
                               ...
                               // propioactual = this.spConsultastockpropi();
                                ...
                                string querypr = "UPDATE libreria.libros SET LI_PROPIO = 0, LI_STOCK = " + stockasetear + " where  LI_CODIGOVIEJO = '" + this.Codigo + "'";
            ...
            finally
            {
              ...
              /*  int stockactualp = this.spConsultastockactual();
                ...
                string query = "UPDATE libreria.libros SET LI_STOCK = " + stockactual + " where  LI_CODIGOVIEJO = '" + this.Codigo + "'";
                con.InsertarYactualiza(query);*/
            ...
            try
            {
                ...
                if (eslibro == 0) //aca pregunto si no es un libro que haga el descuento directamente.
                {
                        ...
                        else
                        {
                            ...
                            if (consignarendi > 0)
                            {
                                ...
                                if (fuerendido == 0)
                                {
                                    ...
                                    string query1 = "UPDATE libreria.consignas SET CONS_CANTIDAD = " + cantidadasumar + " where CONS_IDE = " + this.Consignaide + "";
                                    con.InsertarYactualiza(query1);

                                    int idpren = Convert.ToInt32(reader["PREN_IDE"].ToString());
                                    string queryPREN = "UPDATE libreria.pararendicion SET PREN_ANULADO = 1 where PREN_IDE = " + idpren + "";
                                    con.InsertarYactualiza(queryPREN);
                                    cantidadadescontar = cantidadadescontar - cantirendi;

                                    stockactual = this.spConsultastockactual();
                                    stockasetear = stockactual + cantirendi;
                                    string querystock = "UPDATE libreria.libros SET LI_STOCK = " + stockasetear + " where  LI_CODIGOVIEJO = '" + this.Codigo + "'";
                    ...
                    if (cantidadadescontar > 0)
                    {
                        ...
                        stockpropiop = stockpropio1;
                        string query2 = "UPDATE libreria.libros SET LI_PROPIO = " + stockpropio1 + ", LI_STOCK = " + stockasetear + " where  LI_CODIGOVIEJO = '" + this.Codigo + "'";
                    ...
                    else
                    {
                       /* stockactual = this.spConsultastockactual();
                        stockasetear = stockactual + cantidadaponerstock;
                        string query2 = "UPDATE libreria.libros SET LI_STOCK = " + stockasetear + " where  LI_CODIGOVIEJO = '" + this.Codigo + "'";
                        con.InsertarYactualiza(query2);*/
        ...
        public void colocarventaanulada()
        {
            ...
            string queryanu = "UPDATE libreria.venta SET VEN_ANULADO = " + anulado + " where  VEN_IDE = '" + this.NrodeVta + "'";
        ...
        public MySqlDataReader obtenerdatosproductos()
        {
            ...
            if (this.Tipo == 0)
            {
                reader = con.Consultas("select LI_DESC,LI_AUTOR,LI_EDI_CODIGO,EDI_EDITORIAL,LI_GEN_IDE,GEN_DESC,LI_PRECIO, " +
                                        ...
                                        " from libros " +
                                        " left join libreria.editorial on LI_EDI_CODIGO = EDI_CODIGO " +
                                        " left join libreria.genero on LI_GEN_IDE = GEN_IDE " +
