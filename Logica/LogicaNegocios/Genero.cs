...
namespace LogicaNegocios
{
    public class Genero
    {
        ...
        public DataTable Tabladedatos_generos()
        {
            ...
            return con.Mostrar_Datos("select GEN_IDE,GEN_DESC,GEN_TIPO from libreria.genero where GEN_TIPO = " + esli + " order by GEN_DESC");
        }
        public DataTable Tabladedatos_generos2()
        {
            ...
            return con.Mostrar_Datos("select GEN_IDE,GEN_DESC from libreria.genero where GEN_TIPO = " + esli + " order by GEN_DESC");
        }
        public DataTable Tabladedatos_generosbuscar()
        {
            ...
            Conexion con = new Conexion("libreria", Globales.ip);
            con.AbrirConexio();
            return con.Mostrar_Datos("select * from libreria.genero where " + valor + " order by GEN_DESC");
        }
