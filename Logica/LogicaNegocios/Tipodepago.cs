...
namespace LogicaNegocios
{
    public class Tipodepago
    {
        ...
        public DataTable Mostrar_intereses()
        {
            ...
            return con.Mostrar_Datos("select * from libreria.tipopago ");
        ...
        public DataTable Mostrar_intereses_caja()
        {
            ...
            return con.Mostrar_Datos("select * from libreria.tipopago where TIP_IDE <> 13 and  TIP_IDE <> 12 ORDER BY TIP_DESC");
