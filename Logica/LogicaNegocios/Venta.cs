...
namespace LogicaNegocios
{
    public class Venta
    {
        ...
        int _venptodeventa, _venccorriente, _ventipopago, _venide, _vencantidad, _vendtieneiva, _venusuventapedido, _proformaide, _ventaidparanota;
        ...
        public DataTable Mostrar_pedidotemporal()
        {
            ...
            return con.Mostrar_Datos("select VEN_IDE,VEN_TIPOFACTU,VEN_FECHA,VEN_NOMBRE,VEN_TOTAL,USU_NCOMPLETO " +
                                     " from libreria.tempventa left join usuarios.usuarios on VEN_VENUSU_IDE = USU_IDE ORDER BY VEN_IDE DESC");
        }
