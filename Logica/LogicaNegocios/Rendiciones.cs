...
namespace LogicaNegocios
{
    public class Rendiciones
    {
        ...
        public DataTable Mostrar_rendicionporproducto()
        {
            ...
            return con.Mostrar_Datos("SELECT PREN_FACTU,PREN_CANTIDAD,PREN_FECHAVTA,PREN_IMPORTE,PREN_CONSIGNA,PREN_NRORENDICION,PREN_FECHARENDI FROM pararendicion where PREN_LI_CODIGOVIEJO = '" + this.Codigo + "'");
