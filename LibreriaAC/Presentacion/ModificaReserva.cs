...
namespace Presentacion
{
    public partial class ModificaReserva : Form,IClienteRe,IagregaReserva
    {
        ...
        DateTime _paraavisarfe, _avisadofe, _entregadofe, _alaventafe, _fechamodificado;
        string _codigo, _titulo, _autor, _editorial,_precio, _barra, _cliente, _telefono, _obs, _paraavisarusu, _avisadousu, _entregadousu, _alaventausu, _usuariomodifico;
